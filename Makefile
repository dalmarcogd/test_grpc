build_protos_go:
	...
	protoc --proto_path=protos --go_out=plugins=grpc,import_path=protospb:./go_protos/ protos/*.proto
	xcopy "go_protos\\*.*" "go_client\protospb\\" /s /h /e /k /f /c /y
	xcopy "go_protos\\*.*" "go_server\protospb\\" /s /h /e /k /f /c /y
